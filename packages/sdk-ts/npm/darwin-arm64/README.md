# tap-cdc-darwin-arm64

Native binding for [tap-cdc](https://github.com/levu304/tap) on **macOS arm64 (Apple Silicon)**.
...
- If you're on **Apple Silicon (M1/M2/M3)**: your platform **is** supported. If you see the "not yet built" error, your install resolved the wrong package — try `rm -rf node_modules package-lock.json && npm install tap-cdc`.
- If you're on **Intel macOS (`darwin-x64`)**: this platform is not yet built. Track [the v0.1.1 milestone](https://github.com/levu304/tap/blob/main/.docs/ROADMAP.md).
